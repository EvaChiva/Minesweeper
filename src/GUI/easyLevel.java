...
public class easyLevel extends javax.swing.JFrame {
    ...
    public easyLevel() {
        ...
        this.gridButtons = new JButton[][]{{square0_0, square0_1, square0_2, square0_3, square0_4, square0_5, square0_6}, 
            {square1_0, square1_1, square1_2, square1_3, square1_4, square1_5, square1_6}, 
            {square2_0, square2_1, square2_2, square2_3, square2_4, square2_5, square2_6},
            {square3_0, square3_1, square3_2, square3_3, square3_4, square3_5, square3_6},
            {square4_0, square4_1, square4_2, square4_3, square4_4, square4_5, square4_6},
            {square5_0, square5_1, square5_2, square5_3, square5_4, square5_5, square5_6},
            {square6_0, square6_1, square6_2, square6_3, square6_4, square6_5, square6_6}};
       ...
       //Goes over all the matrix and assigns an action listener to evey button
        ...
        public void actionPerformed (ActionEvent evt){
            ...
            for (int i=0 ; i< (grid.getLevel()).getColumns(); i++) {
                for (int j= 0; j< (grid.getLevel()).getRows(); j++) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(bombContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, -1, -1));

        buttonContainer.setBackground(new java.awt.Color(255, 255, 204));
        buttonContainer.setOpaque(false);

        easyLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/ImagesMineSweeper/Easy game.jpeg"))); // NOI18N
            ...
            .addGroup(buttonContainerLayout.createSequentialGroup()
                ...
                .addGroup(buttonContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(buttonContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(easyLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        getContentPane().add(buttonContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 570, -1));

        background.setIcon(new javax.swing.ImageIcon("/Users/evabeltran/Downloads/fondoLibretaRayada.jpg")); // NOI18N
        getContentPane().add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 570, 610));
